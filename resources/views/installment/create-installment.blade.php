        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" method="POST" action="@if(Auth::guard('admin')->check()) {{route('admin.installments.create.store',[$user->id,$installment_no,$payment])}} @elseif(Auth::guard('admin')->check()) {{route('super_admin.installments.create.store',[$user->id,$installment_no,$payment])}} @endif">
                        @csrf
                        <div class="mb-3">
