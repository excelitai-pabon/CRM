        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" method="POST" action="@if(Auth::guard('admin')->check()) {{route('admin.installments.edit.store',$installment->id)}} @elseif(Auth::guard('admin')->check()) {{route('super_admin.installments.edit.store',$installment->id)}} @endif ">
                        @csrf
                        <div class="mb-3">
