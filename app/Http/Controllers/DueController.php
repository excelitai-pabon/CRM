...
class DueController extends Controller
{
    public function todayAllUserDue()
    {
        ...
        return view('due.today-due',compact('booking_status','after_handover_money','building_pilling','car_parking','down_payment','finishing_money','first_floor','land_filling_1st','land_filling_2nd','installment'));
    }
}
